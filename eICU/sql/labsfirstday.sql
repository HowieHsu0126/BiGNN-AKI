...
INNER JOIN csv_table ON pvt.patientunitstayid = csv_table.patientid
...
-- 将表中的数据导出到CSV文件
COPY (SELECT * FROM labsfirstday) TO '/home/hwxu/Projects/Dataset/PKU/eICU/csv/labsfirstday.csv' DELIMITER ',' CSV HEADER;
