...
(
  ...
  join csv_table on lab.patientunitstayid = csv_table.patientid
  where labname in
  (
        'paO2'
      , 'paCO2'
...
-- 将表中的数据导出到CSV文件
COPY (SELECT * FROM pivoted_bg) TO '/home/hwxu/Projects/Dataset/PKU/eICU/csv/pivoted_bg.csv' DELIMITER ',' CSV HEADER;